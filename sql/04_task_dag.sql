...
AS
  EXECUTE JOB SERVICE
    ...
    spec:
      containers:
        - name: ingest-runner
          image: mrimflq-gt47043.registry.snowflakecomputing.com/sports_analytics_db/raw_bronze/dbt_repo/ingest-runner:v4
          env:
            HYROX_SEASON: "8"
            MAX_ROWS: "5000"
...
AS
  EXECUTE JOB SERVICE
    ...
    spec:
      containers:
        - name: dbt-silver
          image: mrimflq-gt47043.registry.snowflakecomputing.com/sports_analytics_db/raw_bronze/dbt_repo/dbt-runner:v4
